            ...
            <div className="container">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
                    ...
                    <div className="flex flex-col justify-center gap-6 sm:pt-0">
                        <h1 
                            data-aos="fade-up"
                            className="text3xl sm-text-4xl font-bold">
                            Winter Sale upto 50% Off
                        </h1>
                        <p 
                            data-aos="fade-up"
                            className="text-sm text-gray-500 tracking-wine leading-5">
                            Nemo enim ipsam voluptatem quia voluptas sit quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.
                        </p>
