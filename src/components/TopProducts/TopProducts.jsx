...
import Img2 from "../../assets/shirt/shirt1.png";
import Img3 from "../../assets/shirt/shirt2.png";
                            ...
                            <div key={data.id}
                                ...
                                <div className="h-[100px]">
                                    <img src={data.img} alt="" 
                                        className="max-w-[140px] block mx-auto trasform -translate-y-20 group-hover:scale-105 duration-300 drop-shadow-md" />
                                </div>
                                {/* detail section */}
